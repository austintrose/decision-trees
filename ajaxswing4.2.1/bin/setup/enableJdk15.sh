...
cp $AJAXSWING_HOME/lib/install/ajaxswing.jar.jdk1.5 $AJAXSWING_HOME/lib/ajaxswing.jar
cp $AJAXSWING_HOME/lib/install/asboot.jar.jdk1.5    $AJAXSWING_HOME/lib/boot/asboot.jar
